...
/home/yuen_chen/.conda/envs/enco/bin/python experiments/export_cd_train_eval_csv.py \
...
```bash
CUDA_VISIBLE_DEVICES=0 /home/yuen_chen/.conda/envs/enco/bin/python experiments/run_cd_curriculum.py \
